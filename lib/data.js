...
module.exports = function (apiKey, options) {
    ...
    var WistiaData = {
        ...
        /*
         * @param pagination_options {object} page, per_page, sort_by and sort_direction
         * @param Callback {any}
         */
        projectList: function (pagination_options, cb) {

            if (typeof pagination_options === 'function') {
              cb = pagination_options;
              pagination_options = {};
            }

            _util.buildQuery('projects', pagination_options, function (error, data) {
