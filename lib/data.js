...
module.exports = function (apiKey, options) {
    ...
    WistiaData = {
        ...
        projectDelete: function (project_id, cb) {
            ...
            _buildQuery('projects/' + project_id, {_method: 'DELETE'}, function (error, data) {
        ...
        projectCopy: function (project_id, copy_options, cb) {
            ...
            _buildQuery('projects/' + project_id + '/copy', copy_options, function (error, data) {
        ...
        projectSharingsList: function (project_id, cb) {
            ...
            _buildQuery('projects/' + project_id + '/sharings', {}, function (error, data) {
        ...
        projectSharingsShow: function (project_id, sharing_id, cb) {
            ...
            _buildQuery('projects/' + project_id + '/sharings/' + sharing_id, {}, function (error, data) {
        ...
        projectSharingsCreate: function (project_id, sharing_data, cb) {
            ...
            _buildQuery('projects/' + project_id + '/sharings', sharing_data, function (error, data) {
        ...
        projectSharingsDelete: function (project_id, sharing_id, cb) {
            ...
            _buildQuery('projects/' + project_id + '/sharings/' + sharing_id, {_method: 'DELETE'}, function (error, data) {
        ...
        mediaCopy: function (media_id, copy_options, cb) {
            ...
            _buildQuery('medias/' + media_id + '/copy', copy_options, function (error, data) {
        ...
        customizationsShow: function (media_hash_id, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/customizations', {}, function (error, data) {
        ...
        customizationsDelete: function (media_hash_id, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/customizations', {_method: 'DELETE'}, function (error, data) {
        ...
        captionsIndex: function (media_hash_id, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions', {}, function (error, data) {
        ...
        captionsCreate: function (media_hash_id, caption_data, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions', caption_data, function (error, data) {
        ...
        captionsShow: function (media_hash_id, lang_code, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions/' + lang_code, {}, function (error, data) {
        ...
        captionsUpdate: function (media_hash_id, caption_data, lang_code, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions/' + lang_code, caption_data, function (error, data) {
        ...
        captionsDelete: function (media_hash_id, lang_code, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions/' + lang_code, {_method:'DELETE'}, function (error, data) {
        ...
        captionsPurchase: function (media_hash_id, lang_code, cb) {
            ...
            _buildQuery('medias/' + media_hash_id + '/captions/purchase', {}, function (error, data) {
